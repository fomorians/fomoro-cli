...
exports.getStatus = function(item) {
  ...
  var percent = (((completedEpochs + 1) / totalEpochs) * 100).toFixed(1);
  var progress = (completedEpochs + 1) + '/' + totalEpochs;
  ...
  if (state == 'running') {
    ...
    var eta = diff * (totalEpochs / (completedEpochs - 1));
